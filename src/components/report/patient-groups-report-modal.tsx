  ...
  return (
    <DialogContent className="sm:max-w-4xl p-0 max-h-[90vh] flex flex-col">
      <DialogHeader className="p-4 bg-primary text-primary-foreground flex-shrink-0">
        ...
        <DialogClose asChild>
          <button className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none text-primary-foreground hover:text-primary-foreground/80">
            <X className="h-4 w-4" />
